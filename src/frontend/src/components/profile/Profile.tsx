            ...
            <div className="container">
                <div id="outer__container">
                    ...
                    <div id="variants">
                        ...
                        <Link className={classNames("variant variant_2", { 'variant_active variant_active_2': currentTab === '/exercises' })} to={'/exercises'}>
                            Упражнения
                        </Link>

                        <Link className={classNames("variant variant_3", { 'variant_active variant_active_3': currentTab === '/docs' })} to={'/docs'}>
                            Документы
                        </Link>
                    </div>
                </div>
